...
<body>
<footer class="section-footer bg-gray-light py-4 mt-5" style="background-color: rgba(209,204,204,0.59)">
...
<%--        <section class="footer-bottom d-flex justify-content-lg-between border-top py-3">--%>
<%--            <div>--%>
